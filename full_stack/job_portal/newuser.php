...
if ($_SERVER['REQUEST_METHOD'] == "POST"){
    ...
    if(empty(trim($_POST["username"]))){
        ...
        echo"<script type='text/javascript'>window.alert('The username cannot be blank');</script>";
    }
    else{
        ...
        {   
            ...
            if(mysqli_stmt_execute($stmt)){
                ...
                if(mysqli_stmt_num_rows($stmt) == 1)
                {
                    ...
                    echo"<script type='text/javascript'>window.alert('The username is already taken');</script>";
                }
                else{
                ...
                echo"<script type='text/javascript'>window.alert('Somwthing went wrong');</script>";
            }
...
if(empty(trim($_POST['password']))){
    ...
    echo"<script type='text/javascript'>window.alert('Password cannot be blank');</script>";
}
elseif(strlen(trim($_POST['password'])) < 5){
    $password_err = "Password cannot be less than 5 characters";
    echo"<script type='text/javascript'>window.alert('Password cannot be less than 5 characters');</script>";
}
else{
...
if(trim($_POST['password']) !=  trim($_POST['confirm_password'])){
    ...
    echo"<script type='text/javascript'>window.alert('passwords should match');window.location='newuser.php';</script>";
}
//name
