...
if ($_SERVER['REQUEST_METHOD'] == "POST")
{
    ...
    $sql="select * from users where email='".$username."'AND passd='".$password."'limit 1";
    ...
    if ($result->num_rows==1) 
    {
        ...
        echo $username." ".$password."<br>";
        echo"<script type='text/javascript'>window.alert('Invalid Username or Password');window.location='login.php';</script>";
    }*/
    ...
    if(empty($error))
    {
        ...
        if(mysqli_stmt_execute($stmt))
        {
            ...
            {
                echo"<script type='text/javascript'>window.alert('wrong username');</script>";
            }
        }
    }
}
