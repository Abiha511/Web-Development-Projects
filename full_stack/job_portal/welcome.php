<?php
ini_set('session.cookie.domain','login.php');
session_start();
...
<body>
    <header>
        <nav class="navbar">
            ...
            <div class="brandname">
                <ul class="name1">Make It Work</ul>
            </div>
            <ul class="item1" onclick="location.href='about.html'"><i class="fa fa-info"></i>About Us</ul>
            <ul class="item2" onclick="location.href='contact.php'"><i class="fa fa-address-book"></i>Contact Us</ul>
            <ul class="blank1">
    ...
    <div class="container1">
        ...
        <div class="details">
            ...
            <div class="name">
                ...
                echo "USER ID : XYZ7iS".$_SESSION['id'];
                echo "<br><br>";
